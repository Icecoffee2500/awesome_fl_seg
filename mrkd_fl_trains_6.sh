...
uv run -m train_fl -- 'fl.target_resolutions={0:[512,512],1:[384,384],2:[256,256]}' device_id=6 fl.mrkd_alpha=0.3
uv run -m train_fl -- 'fl.target_resolutions={0:[512,512],1:[384,384],2:[256,256]}' device_id=6 fl.mrkd_alpha=0.5