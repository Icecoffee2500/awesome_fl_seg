...
# 512 / 512 / 512 (fl)
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes' 'dataset.test_scale=[2048, 1024]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes_1536x768' 'dataset.test_scale=[1536, 768]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes_1024x512' 'dataset.test_scale=[1024, 512]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes_896x448' 'dataset.test_scale=[896, 448]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes_768x384' 'dataset.test_scale=[768, 384]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes_640x320' 'dataset.test_scale=[640, 320]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:22/fl_1/best_model_fl.pth' 'test_data_root=data/cityscapes_512x256' 'dataset.test_scale=[512, 256]'

# 384 / 384 / 384 (fl)
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes' 'dataset.test_scale=[2048, 1024]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes_1536x768' 'dataset.test_scale=[1536, 768]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes_1024x512' 'dataset.test_scale=[1024, 512]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes_896x448' 'dataset.test_scale=[896, 448]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes_768x384' 'dataset.test_scale=[768, 384]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes_640x320' 'dataset.test_scale=[640, 320]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:23/fl_2/best_model_fl.pth' 'test_data_root=data/cityscapes_512x256' 'dataset.test_scale=[512, 256]'

# 256 / 256 / 256 (fl)
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes' 'dataset.test_scale=[2048, 1024]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes_1536x768' 'dataset.test_scale=[1536, 768]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes_1024x512' 'dataset.test_scale=[1024, 512]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes_896x448' 'dataset.test_scale=[896, 448]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes_768x384' 'dataset.test_scale=[768, 384]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes_640x320' 'dataset.test_scale=[640, 320]'
uv run -m test_cl 'test_checkpoint_path=performance/1013_13:24/fl_3/best_model_fl.pth' 'test_data_root=data/cityscapes_512x256' 'dataset.test_scale=[512, 256]'